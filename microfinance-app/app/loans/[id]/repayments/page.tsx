          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {repayments.map((repayment) => (
              <tr key={repayment.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  {(() => {
                    const type = repayment.paymentType?.toUpperCase();
                    if (type === 'INTEREST_ONLY' || repayment.paymentType === 'interestOnly') {
                      return (
                        <span className="px-3 py-1.5 text-sm font-medium rounded-full bg-blue-100 text-blue-800 border border-blue-300 shadow-sm flex items-center w-fit">
                    ...
                    } else if (type === 'DOCUMENT_CHARGE') {
                      return (
                        <span className="px-3 py-1.5 text-sm font-medium rounded-full bg-orange-100 text-orange-800 border border-orange-300 shadow-sm flex items-center w-fit">
                      ...
                      return (
                        <span className="px-3 py-1.5 text-sm font-medium rounded-full bg-green-100 text-green-800 border border-green-300 shadow-sm flex items-center w-fit">
            ...
            <div className="mr-6">
              ...
              <div className="text-xs text-gray-500 mt-1">
                (Profit: {formatCurrency(repayments.reduce((sum, item) => {
                  ...
                  const type = item.paymentType?.toUpperCase();
                  if (type === 'DOCUMENT_CHARGE') {
                    return sum + item.amount;
                  } else if (type === 'INTEREST_ONLY' || item.paymentType === 'interestOnly') {
