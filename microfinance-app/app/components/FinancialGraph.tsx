          ...
          >
            <div className="flex justify-between items-center mb-4">
              <div>
                <h2 className="text-xl font-bold text-blue-700">
                  Financial Details: {selectedPeriod.period}
                </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-700 mb-2">Cash Flow</h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Cash Inflow:</span>
                    <span className="font-medium text-blue-600">{formatCurrency(selectedPeriod.cashInflow)}</span>
                  </div>
                  ...
                  <div className="flex justify-between mt-2">
                    ...
                    <span className="font-medium text-red-600">{formatCurrency(selectedPeriod.cashOutflow)}</span>
                  </div>
                  <div className="flex justify-between text-sm text-gray-500 pl-4">
                  ...
                  <div className="flex justify-between border-t border-blue-200 pt-2 mt-2">
                    ...
                    <span className={`font-semibold ${selectedPeriod.cashFlowDetails.netCashFlow >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                      {formatCurrency(selectedPeriod.cashFlowDetails.netCashFlow)}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-green-700 mb-2">Profit</h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Loan Profit:</span>
                    <span className="font-medium text-purple-600">{formatCurrency(selectedPeriod.loanProfit)}</span>
                  </div>
                  <div className="flex justify-between text-sm text-gray-500 pl-4">
                  ...
                  <div className="flex justify-between mt-2">
                    <span className="text-gray-600">Chit Fund Profit:</span>
                    <span className="font-medium text-blue-600">{formatCurrency(selectedPeriod.chitFundProfit)}</span>
                  </div>
                  <div className="flex justify-between text-sm text-gray-500 pl-4">
                  ...
                  <div className="flex justify-between border-t border-green-200 pt-2 mt-2">
                    ...
                    <span className="font-semibold text-green-600">{formatCurrency(selectedPeriod.profit)}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-orange-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-orange-700 mb-2">Outside Amount</h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Loan Remaining Amount:</span>
                    <span className="font-medium text-purple-600">
                      {formatCurrency(selectedPeriod.outsideAmountBreakdown.loanRemainingAmount)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Chit Fund Outside Amount:</span>
                    <span className="font-medium text-blue-600">
                      {formatCurrency(selectedPeriod.outsideAmountBreakdown.chitFundOutsideAmount)}
                    </span>
                  </div>
                  <div className="flex justify-between border-t border-orange-200 pt-2 mt-2">
                    ...
                    <span className="font-semibold text-orange-600">{formatCurrency(selectedPeriod.outsideAmount)}</span>
                  </div>
                </div>
              </div>

              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-purple-700 mb-2">Transaction Summary</h3>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Loan Disbursements:</span>
                    <span className="font-medium">{selectedPeriod.transactionCounts.loanDisbursements}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Loan Repayments:</span>
                    <span className="font-medium">{selectedPeriod.transactionCounts.loanRepayments}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Chit Fund Contributions:</span>
                    <span className="font-medium">{selectedPeriod.transactionCounts.chitFundContributions}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Chit Fund Auctions:</span>
                    <span className="font-medium">{selectedPeriod.transactionCounts.chitFundAuctions}</span>
                  </div>
                  <div className="flex justify-between border-t border-purple-200 pt-2 mt-2">
                    ...
                    <span className="font-semibold text-purple-600">{selectedPeriod.transactionCounts.totalTransactions}</span>
                  </div>
                </div>
              </div>
            </div>
